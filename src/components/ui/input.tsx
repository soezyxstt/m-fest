  ...
  ({ className, ...props }, ref) => {
    return (
      <div className='relative w-full'>
        ...
        <input
          className={cn(
            'bg-[#242424] w-full rounded-[1rem] disabled:cursor-not-allowed placeholder:text-muted [box-shadow:inset_4px_4px_27.5px_0px_rgba(0,0,0,.75)] text-text px-4 py-2 z-1 relative text-sm',
            className
          )}
          ref={ref}
          {...props}
