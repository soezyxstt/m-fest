...
export default function HelpButton() {
  ...
  return (
    <motion.button ref={ref} onClick={() => setExpanded(prev => !prev)} layout className='px-4 py-2 absolute bottom-6 right-4 md:bottom-8 md:right-6 z-50 gap-3 backdrop-blur-sm bg-white/30 border border-white text-clear-sky-m font-medium overflow-hidden'
      style={{
