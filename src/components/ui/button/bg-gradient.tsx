...
export default function GradientButton({
  ...
  return (
    ...
    >
      <div className='absolute h-[calc(100%+2px)] w-[calc(100%+2px)] rounded-[calc(.75rem+1px)] bg-linear-60 from-purple-m via-clear-sky-m via-40% to-azure-m to-75% -top-[1px] -left-[1px] z-0' />
      <button
