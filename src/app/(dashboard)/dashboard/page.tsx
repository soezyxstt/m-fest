      ...
      <div
        ...
        <div className="md:col-span-2 grid grid-rows-2 gap-2 md:w-1/2">
          <div className="h-full w-full relative">
            ...
            <ImageUpload revalidate={revalidate} prefix={pKTM} onTop={!!profile?.ktm} desc='Upload your KTM/Student Card' />
          </div>
        ...
        <div className="md:w-1/4 relative">
          ...
          <ImageUpload revalidate={revalidate} prefix={pTwibbon} onTop={!!profile?.twibbon} desc='Upload your Twibbon Screenshot' />
        </div>
        <div className="md:w-1/4 relative">
          {!!profile?.followIG && <CldImage src={profile?.followIG ?? ""} alt={'upload ig'} width={300} height={500}
            className="w-full object-cover object-center h-full rounded-md" />}
          <ImageUpload revalidate={revalidate} onTop={!!profile?.followIG} prefix={pIG} desc="Upload M-Fest's Ig following proof" />
        </div>
      </div>
    </div>
  )
